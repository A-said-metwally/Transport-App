...
export default function Login() {
  ...
  const login = async (e)=>{
    ...
    return (
      <div className=' h-screen w-screen text-gray-100 bg-gradient-to-br from-blue-700 via-blue-400 to-blue-200 mx-auto '>
      
      {loading && <Loading/>}
      
      {!loading && 
        <div className=' sm:max-w-md mx-auto w-full p-10 flex flex-col justify-center items-start  pt-14'>
