...
function TrackingBtn({caption, end, submitData, step, stepNo, no}) {
    ...
    <div className='  relative flex flex-col justify-center items-center'>
        ...
        <button className='rounded-full h-[125px] w-[125px]  text-slate-50 border-2 border-orange-600
            ...
            onClick={()=>{setShowConfirmation(true), console.log('clicked')}}
        ...
        {ShowConfirmation &&
            <div className=' absolute top-0 left-0 w-full h-[150%] z-10 bg-gray-200 rounded-lg shadow-md flex flex-col justify-center items-center space-y-6'>
                <div className='w-full flex flex-col justify-center items-center'>
                    <span className=' text-lg'>Inter Counter Reading</span>
